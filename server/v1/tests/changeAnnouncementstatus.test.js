...
describe('Update an announcement', () => {
  ...
  it('Should not update announcement status if there is Validation error', done => {
    chai
      .request(app)
      .patch('/api/v1/admin/announcement/1')
      .send(announcement2)
      .end((err, res) => {
  ...
  it('Should find the announcement if exists', done => {
    chai
      .request(app)
      .patch('/api/v1/admin/announcement/1231')
      .send(announcement1)
      .end((err, res) => {
  ...
  it('Should update the announcement status', done => {
    chai
      .request(app)
