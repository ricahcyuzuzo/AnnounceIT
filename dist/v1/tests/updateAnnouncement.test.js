...
describe('Update an announcement', function () {
  ...
  it('Should not update announcement if there is Validation error', function (done) {
    _chai["default"].request(_app["default"]).patch('/api/v1/user/announcement/1').send(announcement2).end(function (err, res) {
  ...
  it('Should find the announcement if exists', function (done) {
    _chai["default"].request(_app["default"]).patch('/api/v1/user/announcement/1231').send(announcement1).end(function (err, res) {
  ...
  it('Should update the announcement', function (done) {
